/**
 * @file scripts/whatsapp_viral_channel_bot.js
 * 
 * Autonomous Viral WhatsApp Channel & Social Feeder Bot.
 * 
 * Usage:
 *   node scripts/whatsapp_viral_channel_bot.js
 *   node scripts/whatsapp_viral_channel_bot.js --category=teardown
 *   node scripts/whatsapp_viral_channel_bot.js --category=swipe_file
 *   node scripts/whatsapp_viral_channel_bot.js --category=case_study
 *   node scripts/whatsapp_viral_channel_bot.js --category=reaction_trigger
 *   node scripts/whatsapp_viral_channel_bot.js --category=direct_offer
 *   node scripts/whatsapp_viral_channel_bot.js --dispatch-admin
 */
...
let category = null;
let dispatchAdmin = false;

for (const arg of args) {
  if (arg.startsWith('--category=')) {
    category = arg.split('=')[1];
  } else if (arg === '--dispatch-admin') {
    dispatchAdmin = true;
  }
}

const VIRAL_ROTATION = [
  {
    category: 'teardown',
    dayOfWeek: 'Monday',
...
const CHANNEL_URL = 'https://whatsapp.com/channel/0029VbDFgKP4o7qM58yY9v2l';
const SIGNATURE = '*Bethelmind Analytics Lagos Team*';

function getPost() {
  if (category) {
    const match = VIRAL_ROTATION.find(p => p.category === category);
    if (match) return match;
  }
  const day = new Date().getDay();
  const index = day === 0 ? 6 : day - 1;
  return VIRAL_ROTATION[index] || VIRAL_ROTATION[0];
}

async function run() {
  const post = getPost();

  const formattedBroadcast = `${post.title}
...
👉 Follow our VIP Channel: ${CHANNEL_URL}
✍️ _${SIGNATURE}_`;

  const shareUrl = `https://wa.me/?text=${encodeURIComponent(formattedBroadcast)}`;

  console.log('\n================================================================');
  console.log('🚀 BETHELMIND AUTONOMOUS VIRAL WHATSAPP CHANNEL BOT');
  console.log('================================================================');
  console.log(`📅 Day: ${post.dayOfWeek} | Category: [${post.category.toUpperCase()}]`);
  console.log(`📢 Target Channel: ${CHANNEL_URL}`);
  console.log(`📲 Direct Admin DM Hook: 0802 279 1227 (ADMIN_WA_PHONE)\n`);

  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('1️⃣  WHATSAPP CHANNEL BROADCAST (Post Directly into Channel):');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log(formattedBroadcast);

  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('2️⃣  WHATSAPP STATUS TEASER (Post to Personal Status to drive followers):');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log(post.statusTeaser);
  console.log(`Link: ${CHANNEL_URL}`);

  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('3️⃣  CROSS-PLATFORM FEEDERS (Post to X/Twitter & LinkedIn to funnel traffic):');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🐦 [X / TWITTER]:');
  console.log(post.socialFeederPost.twitter);
  console.log('\n💼 [LINKEDIN]:');
  console.log(post.socialFeederPost.linkedin);

  console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('⚡ 1-CLICK INSTANT WHATSAPP SHARE LINK:');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log(shareUrl);
  console.log('================================================================\n');

  // Save to scratch for API and web UI consumption
  const outputData = {
    generatedAt: new Date().toISOString(),
    dayOfWeek: post.dayOfWeek,
    category: post.category,
    channelPost: formattedBroadcast,
    statusTeaser: post.statusTeaser,
    socialFeeders: post.socialFeederPost,
    shareUrl,
  ...
  fs.writeFileSync(
    path.join(scratchDir, 'latest_channel_broadcast.json'),
    JSON.stringify(outputData, null, 2)
  );

  console.log('✅ Channel payload saved to scratch/latest_channel_broadcast.json');
}
