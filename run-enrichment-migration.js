...
async function runMigration() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, 'supabase', 'migrations', '20260629_add_enrichment_columns.sql');
    ...
    console.log("✔ SQL Migration executed successfully! Enrichment columns added to 'leads' table.");
  } catch (err) {
