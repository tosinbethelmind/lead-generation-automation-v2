...
import { Star, Phone, Mail, MapPin, Award, CheckCircle, ArrowRight, ShieldCheck } from 'lucide-react';
...
export default function PreviewPage() {
  ...
  if (error || !data) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: '#090d16', color: '#fff', fontFamily: 'system-ui', padding: '20px', textAlign: 'center' }}>
        ...
        <a href="/" style={{ marginTop: '24px', padding: '10px 20px', background: '#1e293b', border: '1px solid #334155', borderRadius: '8px', color: '#fff', textDecoration: 'none', fontSize: '0.9rem' }}>
          Return to Console
        </a>
      </div>
    );
  ...
  return (
    <div style={{ 
      ...
      minHeight: '100vh',
      position: 'relative',
      paddingTop: '64px', // Space for sticky preview banner
      overflowX: 'hidden'
    }}>
      {/* Dynamic Font Import */}
      <link 
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '50px', alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 20px 25px rgba(0,0,0,0.1)' }}>
            ...
            <div style={{ 
              ...
              <div>
                <p style={{ margin: 0, fontWeight: 700, color: '#1f2937', fontSize: '0.95rem' }}>Lagos Verified Reputation</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '30px' }}>
            {copy.testimonials.map((test, idx) => (
              <div key={idx} style={{ 
                ...
                <p style={{ color: '#4b5563', fontStyle: 'italic', lineHeight: 1.6, marginBottom: '20px', fontSize: '0.95rem' }}>"{test.text}"</p>
      ...
      {/* Automation Workflow Demo Section */}
      <section id="automation-demo" style={{
        background: '#f8fafc',
          ...
          <div style={{
            ...
            {!demoStatus ? (
              <form onSubmit={handleTestSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                >
                  {demoLoading ? 'Processing Request...' : 'Trigger Automated Test Booking'} <ArrowRight size={18} />
                </button>
              </form>
            ) : (
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
                <CheckCircle size={56} style={{ color: '#10b981', margin: '0 auto 20px' }} />
                <h3 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#1f2937', marginBottom: '8px' }}>Automation Succeeded!</h3>
        ...
        <div style={{ 
          ...
          {!claimed ? (
            <>
              ...
              <form onSubmit={(e) => { e.preventDefault(); setClaimed(true); }} style={{ display: 'flex', flexDirection: 'column', gap: '16px', textAlign: 'left' }}>
                <div>
            ...
            <div style={{ padding: '20px 0' }}>
              ...
              <p style={{ color: '#64748b', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '24px' }}>
                Thank you! We've received your request to claim the website and domain for <strong>{lead.name}</strong>. An outreach manager will contact you at the email provided to transfer domain ownership and provide editor login details.
              </p>
              <button 
