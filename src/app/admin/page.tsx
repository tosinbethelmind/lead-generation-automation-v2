...
export default function AdminDashboardHome() {
  ...
  const systemStats = [
    ...
    { name: 'Active Domain', value: 'lead-generation-automation-i0tmyufyc.vercel.app', status: 'ready', icon: ExternalLink },
  ];
      ...
      <div className="bento-grid">
        ...
        <div className="bento-card welcome-card glass-panel col-span-2">
          ...
          <div className="live-link-box">
            ...
            <a
              href="https://lead-generation-automation-i0tmyufyc.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="live-url"
            >
              https://lead-generation-automation-i0tmyufyc.vercel.app/
