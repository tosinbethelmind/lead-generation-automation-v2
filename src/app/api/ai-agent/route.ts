...
export async function POST(req: NextRequest) {
  try {
    ...
    const { action = 'chat', sessionId, message, sector, leadData, config, messagesHistory } = body;
    ...
    const response = await processCustomerMessage(activeSessionId, message, sector || 'general', leadData, messagesHistory);
