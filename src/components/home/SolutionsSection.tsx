...
const SOLUTIONS = [
  {
    ...
    desc: 'Respond to common questions, capture enquiry details, and route qualified conversations to your team.',
  ...
  },
  {
    ...
    color: '#06b6d4',
    title: 'Lead Follow-Up and Simple CRM',
    desc: 'Keep leads organised and support consistent follow-up from first contact to next action.',
    action: 'Explore Workflow',
    href: '#crm-preview',
  },
  {
    ...
    icon: Calculator,
    color: '#8b5cf6',
    title: 'Sector Tools and Quote Calculators',
    desc: 'Use tailored calculators, forms, and quote workflows for the way your industry sells.',
    action: 'Explore Workflow',
    href: '#sector-tools',
  },
  {
    ...
    icon: Workflow,
    color: '#f59e0b',
    title: 'Campaign and Workflow Automation',
    desc: 'Connect repeatable marketing and follow-up steps into a clearer customer journey.',
    action: 'Explore Workflow',
    href: '#how-it-works',
  },
];
