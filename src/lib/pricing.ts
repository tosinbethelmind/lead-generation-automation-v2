...
export const NIGERIAN_MARKET_TIERS: MarketPackageTier[] = [
  {
    ...
    features: [
      ...
      'Basic Social Media Links (IG, FB, TikTok)',
    ],
    recommendedFor: 'Small Instagram vendors, artisans, single technicians, local shops',
  },
  {
    id: 'pro',
    name: 'Business Growth & Transfer Portal',
    badge: 'Most Popular (70% Choice)',
    priceNGN: 185000,
    originalPriceNGN: 370000,
    popular: true,
    simplicityHighlights: [
      '🏦 Moniepoint / Wema Dedicated Virtual Account (Instant Bank Transfer)',
      '🛡️ Verified Nigerian Business Shield Badge (CAC / NIN Verified)',
      '📊 Auto-syncs leads to Google Sheets CRM (No login needed)',
  ...
  {
    id: 'vip',
    name: 'VIP AI Sales Agent Suite',
    badge: '100% Hands-Free AI',
    priceNGN: 480000,
    originalPriceNGN: 950000,
    simplicityHighlights: [
      '🤖 24/7 AI WhatsApp Auto-Reply Bot (Answers customer inquiries while you sleep)',
    ...
    features: [
      ...
      '24/7 AI WhatsApp & Email Auto-Reply Agent',
      'Multi-Channel Drip Outreach (WhatsApp + SMS + Email)',
  ...
  },
  {
    ...
    simplicityHighlights: [
      ...
      '🤖 Autonomous AI Sales Representative (Custom Trained on your ERP / Products)',
      '📊 Custom Executive CEO Weekly PDF Performance Audit',
    ],
    features: [
...
export const SECTOR_SAAS_PRICING: Record<string, SectorSaasConfig> = {
  solar: {
    ...
    starter: {
      ...
      annualNGN: 220000,
      setupFeeNGN: 15000,
      features: ['BOQ Auto-Generator (kVA/Inverter/Batteries)', 'Diesel vs Solar 5-Yr ROI Calculator', 'WhatsApp Quote Dispatch'],
    },
    pro: {
      monthlyNGN: 45000,
      ...
      annualNGN: 420000,
      setupFeeNGN: 25000,
      features: ['Everything in Starter', 'DISCO Band A-E Tariff Hybrid Calculator', 'Solar-as-a-Service Lease-to-Own Payback', 'Moniepoint DVA Transfer Box', 'Unlimited Branded PDF Invoices'],
    },
    enterprise: {
      monthlyNGN: 95000,
      ...
      annualNGN: 890000,
      setupFeeNGN: 50000,
      features: ['Everything in Pro', 'Multi-installer Sales Team Lead Router', 'WhatsApp Voice Note Lead Transcriber', '24/7 AI WhatsApp & Call Qualifier Agent (150 Mins Inc.)'],
    },
  },
  auto: {
    sectorKey: 'auto',
    ...
    starter: {
      ...
      annualNGN: 200000,
      setupFeeNGN: 15000,
      features: ['Tokunbo Customs Duty Calculator (NCS 2026)', 'Vehicle Listing Showcase', 'Appraisal Allowance Widget'],
    },
    pro: {
      monthlyNGN: 35000,
      ...
      annualNGN: 350000,
      setupFeeNGN: 20000,
      features: ['Everything in Starter', 'Multi-Port Clearing Difference Matrix (Tin Can / Apapa / PTML)', '17-Digit VIN History Specs Decoder', 'Moniepoint DVA Transfer Box'],
    },
    enterprise: {
      monthlyNGN: 75000,
      ...
      annualNGN: 750000,
      setupFeeNGN: 40000,
      features: ['Everything in Pro', 'WhatsApp Auto-Matcher for Spare Parts', 'Dealer Test-Drive Calendar Sync', '24/7 AI WhatsApp Deal Closer'],
    },
  },
  legal: {
    sectorKey: 'legal',
    ...
    starter: {
      ...
      annualNGN: 150000,
      setupFeeNGN: 10000,
      features: ['CAC Business Filing Fee Calculator', 'CAC Name Availability Checker', 'Client Inquiry Portal'],
    },
    pro: {
      monthlyNGN: 30000,
      ...
      annualNGN: 300000,
      setupFeeNGN: 15000,
      features: ['Everything in Starter', 'Automated MEMART, NDA & Retainership Document Generator', 'FIRS 0.75% Stamp Duty Estimator', 'Two-Way Google Sheets CRM Sync'],
    },
    enterprise: {
      monthlyNGN: 65000,
      ...
      annualNGN: 650000,
      setupFeeNGN: 30000,
      features: ['Everything in Pro', 'Identity KYC Verification Shield (NIN, BVN, CAC RC Check)', 'Corporate Retainer Billing Tracker'],
    },
  },
  retail: {
    sectorKey: 'retail',
    ...
    starter: {
      ...
      annualNGN: 80000,
      setupFeeNGN: 5000,
      features: ['Express WhatsApp Catalog', '1-Tap WhatsApp Order Builder', 'Scraped Customer Reviews Display'],
    },
    pro: {
      monthlyNGN: 15000,
      ...
      annualNGN: 150000,
      setupFeeNGN: 10000,
      features: ['Everything in Starter', 'Moniepoint DVA Dedicated Virtual Account', 'Inter-State Bus Park Waybill & Freight Cost Estimator', 'Verified Nigerian Business Shield Badge'],
    },
    enterprise: {
      monthlyNGN: 35000,
      ...
      annualNGN: 350000,
      setupFeeNGN: 20000,
      features: ['Everything in Pro', '15-Minute Abandoned Cart WhatsApp Drip Recovery', 'Multi-Location Inventory Stock Tracking'],
    },
  },
  healthcare: {
