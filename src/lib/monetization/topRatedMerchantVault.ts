...
export const TOP_RATED_DIAMOND_MERCHANTS: Record<string, DiamondMerchant> = {
  'ALPHADESK_OTC': {
    id: 'ALPHADESK_OTC',
    corporateName: 'AlphaDesk Institutional Liquidity Desk #402',
    escrowBank: 'Providus Bank / Monnify Corporate Clearing',
    accountNumber: 'DYNAMIC_GENERATED_ON_ORDER',
    accountName: 'AlphaDesk OTC / Institutional Settlement Trust',
    directWhatsApp: '+234 809 112 4022',
    directPhone: '+234 809 112 4022',
    deskManager: 'Alhaji Kabir (Lead Settlement Officer)',
    completionRate: '99.88%',
    totalCompletedTrades: 6420,
    bondedCollateralNGN: '₦450,000,000 NGN (Platform Bonded Vault)',
    physicalOffice: 'Plot 12, Commercial Corridor, Victoria Island, Lagos',
    verificationBadge: 'DIAMOND_PRO_VERIFIED'
  },
  'BITDELTA_WHALE': {
    id: 'BITDELTA_WHALE',
    corporateName: 'BitDelta Institutional VIP OTC Desk #118',
    escrowBank: 'Wema Bank / Providus Corporate Clearing',
    accountNumber: 'DYNAMIC_GENERATED_ON_ORDER',
    accountName: 'BitDelta Global / Institutional Escrow Trust',
    directWhatsApp: '+234 813 900 8821',
    directPhone: '+234 813 900 8821',
    deskManager: 'Engr. Emeka Okonkwo (Senior OTC Liquidity Partner)',
    completionRate: '99.94%',
    totalCompletedTrades: 9150,
    bondedCollateralNGN: '₦600,000,000 NGN (Platform Bonded Vault)',
    physicalOffice: 'Zone B, Trade Fair Commercial Complex, Badagry Expressway, Lagos',
    verificationBadge: 'DIAMOND_PRO_VERIFIED'
  }
};
