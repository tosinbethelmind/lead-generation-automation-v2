...
async function runMigration() {
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, 'supabase', 'migrations', '20260706_add_upgrade_columns.sql');
    ...
    console.log("✔ SQL Migration executed successfully! Website modernization columns added to 'leads' table.");
  } catch (err) {
